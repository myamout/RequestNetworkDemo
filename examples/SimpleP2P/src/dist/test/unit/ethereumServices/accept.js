...
describe('accept', function () {
    ...
    it('accept request with not valid requestId', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var result, e_1;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    e_1 = _a.sent();
                    utils.expectEqualsObject(e_1, Error('_requestId must be a 32 bytes hex string'), 'exception not right');
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
    }); });
    it('accept request', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var result;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('accept request by payee or otherguy', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    it('accept request not in created state', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var result, e_4;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
