...
describe('refundAction', function () {
    ...
    it('payBack request', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var result0, result;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('payBack request not fully', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var result;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rn.requestEthereumService.accept(requestId, { from: payer })];
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, rn.requestEthereumService.refundAction(requestId, 10, { from: payee })
                            .on('broadcasted', function (data) {
                            chai_1.expect(data.transaction, 'data.transaction.hash is wrong').to.have.property('hash');
                        })];
                case 3:
    ...
    it('payback request with not valid requestId', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, rn.requestEthereumService.refundAction('0x00000000000000', arbitraryAmount, { from: payer })];
                case 4:
                    result_1 = _a.sent();
    ...
    it('payback request with not valid amount', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, rn.requestEthereumService.refundAction(requestId, -1, { from: payee })];
                case 4:
                    result_2 = _a.sent();
                    chai_1.expect(false, 'exception not thrown').to.be.true;
                    return [3 /*break*/, 6];
    ...
    it('payback request by payer', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, rn.requestEthereumService.refundAction(requestId, arbitraryAmount, { from: payer })];
                case 4:
                    result_3 = _a.sent();
                    chai_1.expect(false, 'exception not thrown').to.be.true;
                    return [3 /*break*/, 6];
    ...
    it('payback request by otherGuy', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, rn.requestEthereumService.refundAction(requestId, arbitraryAmount, { from: otherGuy })];
                case 4:
                    result_4 = _a.sent();
                    chai_1.expect(false, 'exception not thrown').to.be.true;
                    return [3 /*break*/, 6];
    ...
    it('payback request by otherGuy', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    return [4 /*yield*/, rn.requestEthereumService.paymentAction(requestId, 10, 0, { from: payer })];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, rn.requestEthereumService.refundAction(requestId, 11, { from: otherGuy })];
                case 4:
                    result_5 = _a.sent();
                    chai_1.expect(false, 'exception not thrown').to.be.true;
                    return [3 /*break*/, 6];
