...
var RequestEthereumService = /** @class */ (function () {
    ...
    RequestEthereumService.prototype.createRequestAsPayee = function (_payer, _amountInitial, _data, _extension, _extensionParams, _options) {
        ...
        this.web3Single.getDefaultAccountCallback(function (err, defaultAccount) {
            ...
            _this.requestCoreServices.getCollectEstimation(_amountInitial, _this.addressRequestEthereum, _extension).then(function (collectEstimation) {
                ...
                // add file to ipfs
                _this.ipfs.addFile(_data).then(function (hashIpfs) {
                    if (err)
                        return promiEvent.reject(err);
                    var method = _this.instanceRequestEthereum.methods.createRequestAsPayee(_payer, _amountInitial, _extension, paramsParsed, hashIpfs);
                    // submit transaction
                    _this.web3Single.broadcastMethod(method, function (hash) {
                        ...
                        if (confirmationNumber === _options.numberOfConfirmation) {
                            ...
                            _this.getRequest(event_1.requestId).then(function (request) {
                                promiEvent.resolve({ request: request, transaction: { hash: receipt.transactionHash } });
     ...
     */
    RequestEthereumService.prototype.decodeInputData = function (_data) {
     ...
     */
    RequestEthereumService.prototype.generateWeb3Method = function (_name, _parameters) {
